    ...
    return (
        <div className='rounded-md overflow-hidden'>
            ...
            <div className='relative h-[250px] group rounded-md overflow-hidden cursor-pointer'>
                {item?.isTrending && <div className='bg-[#dd3333] p-[6px] absolute top-1 left-1 z-[3] rounded-full text-lg'><FaFire /></div>}
                ...
                <div className='absolute top-0 right-0 z-[4]'>
                    <Chip color='warning' sx={{ padding: "5px 15px", borderRadius: 0, borderBottomLeftRadius: "10px" }}>{item?.subOrDub}</Chip>
                </div>
            </div>
